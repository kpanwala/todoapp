...
export function TODOList({todos, setTodos}) {
    return <ol className="todo_list">
    {
        ...
        (todos.map((item, index)=> <Item key={index} item={item} setTodos={setTodos}></Item>)) : 
        ...
        <li className="todo_item">
          {editing ? (
            ...
            <div className="todo_items_left">
              <svg className="svg_align" onClick={completeTodo}>
                <circle cx="11.998" cy="11.998" fillRule="nonzero" r="9.998" 
                  fill={item.isCompleted ? "#22C55E" : "#545054"}/>
              </svg>
              <p style={item.isCompleted ? { textDecoration: "line-through" } : {}}> {item.title}</p>
            </div>
            <div className="todo_items_right">
              ...
              <button onClick={deleteTodo}>
                <span >
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="35" viewBox="0 0 100 100">
